...
namespace odb
{
  ...
  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  persist_statement_name[] = "persist_eWallets";

  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  find_statement_name[] = "find_eWallets";

  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  update_statement_name[] = "update_eWallets";

  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  erase_statement_name[] = "erase_eWallets";

  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  query_statement_name[] = "query_eWallets";

  const char access::object_traits_impl< ::eWallets, id_pgsql >::
  erase_query_statement_name[] = "erase_query_eWallets";
  ...
  struct access::object_traits_impl< ::eWallets, id_pgsql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::eWallets, id_pgsql >::id_type
  access::object_traits_impl< ::eWallets, id_pgsql >::
  ...
  bool access::object_traits_impl< ::eWallets, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::eWallets, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::eWallets, id_pgsql >::table_name[] =
  "\"wallet\".\"eWallets\"";
  ...
  access::object_traits_impl< ::eWallets, id_pgsql >::pointer_type
  access::object_traits_impl< ::eWallets, id_pgsql >::
  ...
  result< access::object_traits_impl< ::eWallets, id_pgsql >::object_type >
  access::object_traits_impl< ::eWallets, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::eWallets, id_pgsql >::
