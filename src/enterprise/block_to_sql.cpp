...
void BlockToSql::GetOutputRecord(const int& output_transaction_index, const std::string& output_transaction_hash, const int& output_vector, const CTxOut& txout_data, CAmount& total_output_value, int64_t& utxo_size_inc)
{
...
void BlockToSql::GetInputRecord(const int& input_transaction_index, const std::string& input_transaction_hash, const int& input_vector, const CTxIn& txin_data, const bool is_coinbase, CAmount& total_input_value, int64_t& utxo_size_inc)
{
